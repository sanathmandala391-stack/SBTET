    ...
    <div className="auth-page">
      ...
      <div className="auth-right">
        <div className="auth-box fade-in" style={{ maxWidth: step === 2 ? 540 : 460 }}>
          ...
          {/* ── Step 2: Face Registration ──
               FaceCamera now renders as a FULL-SCREEN MODAL (position: fixed).
               It owns its own top bar, status text, and close button —
               no need to wrap it in the old instruction box or Back button. */}
          {step === 2 && (
            <FaceCamera
              mode="register"
